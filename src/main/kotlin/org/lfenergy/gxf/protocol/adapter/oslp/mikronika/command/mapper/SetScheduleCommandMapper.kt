...
import org.lfenergy.gxf.protocol.adapter.oslp.mikronika.command.mapper.CommandMapperFactory.Companion.SET_SCHEDULE_REQUEST
...
class SetScheduleCommandMapper : CommandMapper() {
    ...
    override fun toResponse(
        ...
        deviceResponseMessage {
            ...
            result =
                when (envelope.message.setScheduleResponse.status) {
