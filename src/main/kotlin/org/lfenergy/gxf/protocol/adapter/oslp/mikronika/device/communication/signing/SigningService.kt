...
class SigningService(
    ...
    fun createSignature(data: ByteArray): ByteArray =
        this.createSignature(data, keyProvider.getPrivateKey())

    fun verifySignature(data: ByteArray, signature: ByteArray, deviceIdentification: String): Boolean {
